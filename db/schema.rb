...
ActiveRecord::Schema.define(version: 20191013211537) do
  ...
  create_table "downloads", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["category_id"], name: "index_downloads_on_category_id", using: :btree
  end
  ...
  create_table "maintainace_reports", force: :cascade do |t|
    t.string   "user_id"
    t.string   "location"
    t.string   "category"
    t.text     "description"
  ...
  create_table "mteams", force: :cascade do |t|
    t.string   "title"
    t.text     "question"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "poll_periods", force: :cascade do |t|
    t.string   "period"
    t.boolean  "active"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
